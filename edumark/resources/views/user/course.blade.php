        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="course_text">
                    ...
                    <div class="prise">
                        <span class="inactive">{{ $course['harga_course'] }}</span>
                        <span class="active">Rp. <?php echo ($course['harga_course'] * 75 / 100); ?></span>
                    </div>
                    <div class="rating">
                ...
                <div class="courses_sidebar">
                    ...
                    <div class="author_info">
                        <div class="auhor_header">
                            <div class="thumb">
                                <img src="/uploads/{{ $course['gambar_teacher'] }}" alt="" style="border-radius:50%; width:62px;">
                            </div>
                            <div class="name">
                                <h3>{{ $course['nama_teacher'] }}</h3>
                                <p>{{ $course['job_teacher'] }}</p>
                            </div>
                        </div>
                        <p class="text_info">
                            {{ $course['quote_teacher'] }}. Our set he for firmament morning sixth subdue darkness creeping gathered divide our let
                    ...
                    <a href="/courses/pay/{{ $course['id_course'] }}" class="boxed_btn">Buy Course</a>
