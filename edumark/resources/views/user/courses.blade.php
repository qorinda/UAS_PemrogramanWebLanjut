                ...
                <div class="course_nav">
                    <nav>
                        <ul class="nav" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Android Developer</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Web Developer</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="Adobe-XD-tab8" data-toggle="tab" href="#Adobe-XD8" role="tab" aria-controls="design" aria-selected="false">Language</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="Adobe-XD-tab9" data-toggle="tab" href="#Adobe-XD9" role="tab" aria-controls="design" aria-selected="false">Other</a>
                            </li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="container">
            <div class="tab-content" id="myTabContent">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="single_courses">
                                ...
                                <div class="courses_info">
                                    ...
                                    <h3><a href="/courses/{{ $course['id_course'] }}" class="mb-2">{{ $course['nama_course'] }}</a></h3>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="row">
                        @foreach($courses as $course)
                        <?php if ($course['kategori_course'] == 'Android Developer') { ?>
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single_courses">
                                    <div class="thumb">
                                        <a href="/courses/{{ $course['id_course'] }}">
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    <div class="row">
                        @foreach($courses as $course)
                        <?php if ($course['kategori_course'] == 'Web Developer') { ?>
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single_courses">
                                    <div class="thumb">
                                        <a href="/courses/{{ $course['id_course'] }}">
                ...
                <div class="tab-pane fade" id="Adobe-XD8" role="tabpanel" aria-labelledby="Adobe-XD8">
                    <div class="row">
                        @foreach($courses as $course)
                        <?php if ($course['kategori_course'] == 'Language') { ?>
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single_courses">
                                    <div class="thumb">
                                        <a href="/courses/{{ $course['id_course'] }}">
